...
# Keyboard Layouts
exec setxkbmap -model pc105 -layout us,iq -option 'grp:alt_space_toggle'
...
exec --no-startup-id xss-lock --transfer-sleep-lock -- i3lock -i ~/Pictures/backgrounds/lock.png --nofork  

# NetworkManager is the most popular way to manage wireless networks on Linux,
# and nm-applet is a desktop environment-independent system tray GUI for it.
exec --no-startup-id nm-applet
# default scrol
exec /home/ridha/.script/inverse-scroll.sh

# tap to click
exec /home/ridha/.script/tap-to-click.sh
...
client.unfocused            #727696            #727696               $textcolor      $ibgcolor 
...
bindsym $mod+shift+x exec i3lock -i ~/Pictures/backgrounds/lock.png
...
exec_always feh --bg-scale /home/ridha/Pictures/backgrounds/anime.jpeg
# change focus
